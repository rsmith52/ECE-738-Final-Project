...
seq_frames_dir = os.path.join("data", "madison")
seq_frame_paths = []
...
results_dir = os.path.join(model.project_dir, "results_on_seq_madison")
...
out = cv2.VideoWriter(os.path.join(results_dir, "madison.avi"), fourcc,
