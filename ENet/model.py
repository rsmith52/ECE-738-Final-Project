...
class ENet_model(object):
    ...
    def __init__(self, model_id, img_height=512, img_width=1024, batch_size=4):
        ...
        self.class_weights = cPickle.load(open(os.path.join("data", "class_weights.pkl"), 'rb'))
    ...
    def create_model_dirs(self):
        self.model_dir = os.path.join(self.logs_dir, "model_%s" % self.model_id)
        self.checkpoints_dir = os.path.join(self.model_dir, "checkpoints")
        self.debug_imgs_dir = os.path.join(self.model_dir, "imgs")
