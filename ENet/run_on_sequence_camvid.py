...
seq_frames_dir = os.path.join("data", "camvid")
seq_frame_paths = []
...
results_dir = os.path.join(model.project_dir, "results_on_seq_camvid")
...
out = cv2.VideoWriter(os.path.join(results_dir, "camvid.avi"), fourcc,
